export const enCopy = {
  ...
  home: {
    eyebrow: "VibeSec Promo Board",
    title: "Advertise your app here",
    pitch: "Scan your app and list it on the free promo board.",
    submitCta: "Advertise free",
    viewAll: "View board",
    beta: "Free beta promo board",
  },
  showcase: {
    title: "Advertise your app on VibeSec",
    scanYourApp: "Scan your app",
    loading: "Loading promo board.",
    noPublic: "No promoted apps yet.",
    back: "Back to Promo Board",
  ...
  publish: {
    title: "Add to VibeSec Promo Board",
    appName: "App name",
