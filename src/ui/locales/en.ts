export const enCopy = {
  ...
  scanner: {
    ...
    title: "Scan your app. Fix launch risks. Show off your score.",
    subtitle: "Get a public-ready security score before you launch, share, or post your app.",
    urlLabel: "Website URL",
    placeholder: "https://your-app.vercel.app",
    runScan: "Get my launch score",
    scanning: "Scanning",
    secondaryCta: "Browse showcased apps",
  },
  home: {
    eyebrow: "VibeSec Showcase",
    title: "Advertise your web app right here",
    pitch: "Pass the scan, publish your score, and turn your launch into a promo card.",
    viewAll: "View all",
