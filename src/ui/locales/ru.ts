...
export const ruCopy = {
  ...
  home: {
    ...
    pitch: "Проверьте приложение и покажите его на Launch Board.",
    submitCta: "Добавить приложение",
    viewAll: "Launch Board",
    beta: "Публичная бета Launch Board",
  },
  showcase: {
    title: "Launch Board",
    scanYourApp: "Проверить приложение",
    loading: "Загрузка Launch Board.",
    noPublic: "Запусков пока нет.",
    back: "Назад к Launch Board",
    ...
    voteError: "Не удалось поставить апвоут.",
  ...
  publish: {
    title: "Добавить на VibeSec Launch Board",
