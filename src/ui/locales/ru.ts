...
export const ruCopy = {
  ...
  home: {
    eyebrow: "Сообщество VibeSec",
    title: "Представьте свой сервис",
    pitch: "Проверьте приложение и покажите его сообществу.",
    submitCta: "Добавить приложение",
    viewAll: "Открыть сообщество",
    beta: "Публичная бета сообщества",
  },
  showcase: {
    title: "Сообщество запусков",
    scanYourApp: "Проверить приложение",
    loading: "Загрузка сообщества.",
    noPublic: "Сервисов пока нет.",
    back: "Назад к сообществу",
    loadingReport: "Загрузка публичной страницы.",
    notFound: "Публикация не найдена.",
    publicReport: "Подробнее",
    visitApp: "Открыть сервис",
    hot: "В тренде",
    latest: "Новые",
    popular: "Популярные",
    controls: "Фильтры сообщества",
    searchPlaceholder: "Поиск по приложениям, категориям, стекам, доменам",
    pageSize: "Показать",
    page: "Страница",
    of: (pages: number) => `из ${pages}`,
    results: (count: number) => `${count} результатов`,
    previousPage: "Предыдущая страница",
    nextPage: "Следующая страница",
    upvote: "Рекомендовать",
    upvotes: "Рекомендации",
    comments: "Комментарии",
    commentName: "Ваше имя",
    commentBody: "Добавить комментарий",
    commentSubmit: "Комментировать",
    commenting: "Публикация",
  ...
  report: {
    ...
    riskRules:
      "Диапазоны риска: низкий 90-100, средний 75-89, высокий 0-74. Любая опасная находка делает риск высоким.",
    findings: "Находки",
    counts: {
      dangerous: "опасных",
  ...
  publish: {
    ...
    postTitle: "Заголовок",
    tagline: "Текст",
    body: "Расскажите, что вы сделали и почему это стоит открыть.",
    appUrl: "URL сайта",
    category: "Категория",
    categories: [
      "AI-инструменты",
