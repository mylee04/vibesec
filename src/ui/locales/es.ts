...
export const esCopy = {
  ...
  home: {
    ...
    pitch: "Escanea tu app y compártela en el Launch Board.",
    submitCta: "Enviar mi app",
    viewAll: "Launch Board",
    beta: "Launch Board en beta pública",
  },
  showcase: {
    title: "Launch Board",
    scanYourApp: "Escanear mi app",
    loading: "Cargando Launch Board.",
    noPublic: "Aún no hay lanzamientos.",
    back: "Volver al Launch Board",
    ...
    voteError: "No se pudo votar este lanzamiento.",
  ...
  publish: {
    title: "Enviar al Launch Board de VibeSec",
