...
export const esCopy = {
  ...
  home: {
    eyebrow: "Tablón promocional de VibeSec",
    title: "Anuncia tu app aquí",
    pitch: "Escanea tu app y publícala gratis en el tablón promocional.",
    submitCta: "Anunciar gratis",
    viewAll: "Ver tablón",
    beta: "Tablón gratis en beta",
  },
  showcase: {
    title: "Anuncia tu app en VibeSec",
    scanYourApp: "Escanear mi app",
    loading: "Cargando tablón promocional.",
    noPublic: "Aún no hay apps anunciadas.",
  ...
  publish: {
    title: "Añadir al tablón promocional de VibeSec",
