...
export const jaCopy = {
  ...
  home: {
    ...
    title: "あなたのサービスを紹介",
    pitch: "アプリをスキャンして Launch Board で共有できます。",
    submitCta: "アプリを投稿",
    viewAll: "Launch Board",
    beta: "公開ベータ Launch Board",
  },
  showcase: {
    title: "Launch Board",
    scanYourApp: "自分のアプリをスキャン",
    loading: "Launch Board を読み込み中。",
    noPublic: "まだローンチはありません。",
    back: "Launch Board に戻る",
  ...
  publish: {
    title: "VibeSec Launch Board に投稿",
    appName: "アプリ名",
    tagline: "一行紹介",
    category: "カテゴリ",
